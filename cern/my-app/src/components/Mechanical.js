    ...
    const sprintReviews = [
        ...
        },
        {
            ...
            content: `
                ...
                IMAGES 150-170 HERE SIDE-BY-SIDE
                150 Stubby Sketches.png
                160 Stubby CAD.png
                170 Three Ball Weight.jpg
                ...
                IMAGES 180-210 HERE CAROUSEL
                180 Spring Wheel.jpg
                190 Duro Wheel.jpg
                200 Sanded Ball.jpg
                210 Hot Glue Wheels.jpg
                `,
            imageUrl: '/path-to-sprint2-image.jpg' // Replace with actual image path
        },
        {
            title: 'Sprint 3',
            content: `
                ...
                IMAGES 220-240 HERE FANCY LAYOUT
                220 Final CAD.png
                230 Mass Comparison.png
                240 Tinfoil Comparison.png
                ...
                IMAGES 250-270 HERE CAROUSEL
                250 Charging Base With Sphero.jpg
                260 Empty Charging Base.jpg
                270 Opened Charging Base.jpg
                `,
            imageUrl: '/path-to-sprint3-image.jpg' // Replace with actual image path
        }
    ];

    return (
        <div style={{ width: '100%' }}>
            <div style={{ height: '600px', width: '100%' }} className="main-content">
                <h1>Mechanical</h1>
