    ...
    const sprintReviews = [
        {
            ...
            blocks: [
                {
                    content: `The code for Sprint 1 represents the initial iteration of the control system for the robot using an ESP32 microcontroller. In this early stage, the primary focus is on establishing basic functionality and communication between the ESP32 and a paired device over Bluetooth.`,
                    imageUrl: '/images/450 MAC Address.png'
                },
                {
                    content: `The code implements fundamental motor control and sensor interaction to enable the robot to respond to directional commands sent from a Bash terminal to the specified Bluetooth MAC address.`,
                    imageUrl: '/images/460 Arduino Test Driving Bluetooth Code.png'
                },
                {
                    content: `<p>However, being a first iteration, the code exhibits certain limitations and areas for potential improvement. The inclusion of blocking delays, limited error handling, and the absence of input validation highlight aspects that can be refined in subsequent iterations. These improvements are crucial for enhancing the overall reliability, responsiveness, and robustness of the robot control system.</p>
                ...
                // Additional blocks for Sprint 1 if needed
            ]
        },
        {
            title: 'Sprint 2',
            blocks: [
                ...
                // Additional blocks for Sprint 2 if needed
            ]
        },
        {
            title: 'Sprint 3',
            blocks: [
                ...
                },
                {
                    ...
                    `,
                    imageUrl: '/images/510 Matrix Math.png'
                },
                {
                    content: `We can then calculate the characteristic polynomial to find the eigenvalues of this matrix. Doing this will provide us with three eigenvalues. One that is guaranteed to be zero, while the other two are complex numbers equal to the total acceleration of the robot which are conjugates of each other.
                    `,
                    imageUrl: '/images/520 Determinant Math.png'
                },
                {
                    content: `
                ...
                // Additional blocks for Sprint 3 if needed
            ]
        },
        // Additional sprints if needed
    ];

    return (
        <div className="main-content" style={{ maxWidth: '70%', margin: 'auto' }}>
            <h1>Firmware</h1>
            <p>Insights into the firmware development for motor control, gyroscope data handling, and Bluetooth communication.</p>
