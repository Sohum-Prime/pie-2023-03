    ...
    const sprintContents = [
        {
            ...
            content: `
            IMAGES 370-400 HERE
            370 MOSFET Trigger Breadboard.jpg
            380 IMU Breadboard.jpg
            390 Full Breadboard Oscillator.jpg
            400 Two Induction Coils By Themselves.jpg
        ...
        },
        {
            ...
            IMAGE 410 HERE
            410 Final Induction Circuit.jpg
            `,
        ...
        },
        {
            ...
            <p>Our final transmitting circuit uses a 1.5uF polyfilm capacitor rated at 63V, the pancake coil with a center tap made during Sprint 2, a 15uH cylinder inductor, two IRF1407 power MOSFETs, two 1N4743 zener diodes, a 1N4002 silicon diode, and two 1/4W 1KΩ resistors. Our receiving LC circuit uses the pancake coil made without a center tap during Sprint 2, along with a 1.5uF polyfilm capacitor rated at 63V, which takes the place of the receiving inductor and capacitor on the circuitry/schematic of the PCB specified in the electrical section.</p>


            IMAGE 421 HERE
            421 Some Circuit.png
            ...
            There are also issues with using a ZVS driver and our transmitting coil. Our transmitting coil was oscillating at a higher frequency with the ZVS driver, which differs from the receiving coil’s resonant frequency of 14.2 kHz. We think this is because only half of the coil is switching at a time (due to receiving power from the center tap), though it may also be from other inductive effects that arise when the coils are placed together. For one of the robots, we decided to use an off the shelf induction charger from Adafruit, so that we could charge them in a reasonable amount of time.            </p>
            
            IMAGES 430-440 HERE
            430 EE Proto Room Setup.jpg
            440 EE Proto Room 3 People.jpg
            `,
